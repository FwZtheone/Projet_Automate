...
public class BoardSuperAdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ça permet de se connecter au réseau !!
        ...
        if(intent != null){
            ...
            if(intent.hasExtra("user_email")){
                ...
                TextView textView_user_login = findViewById(R.id.TextView_login_root);
                ...
                textView_user_login.append(login);

                //création des textview pour le password etc..
                TextView textView_user_email = findViewById(R.id.TextView_email_root);
                TextView textView_user_password = findViewById(R.id.TextView_password_root);
                TextView textView_user_ecriture = findViewById(R.id.TextView_ecriture_root);
